...
export const EVENTOS = [
  ...
  "social_click",
  "website_click",
  // Tocar "Pedir por WhatsApp" y mandar el pedido armado desde la carta. Son
  // dos porque la distancia entre ellos es lo que dice si la carta digital
  // está vendiendo o solo consultándose.
  "whatsapp_click",
  "whatsapp_order",
  // Los dos lados de un cupón en la ficha: verlo y llevarse el código. El
  // tercero —canjearlo en la caja— lo registra el dueño y no es un evento:
  // vive en `coupon_redemptions`, porque no ocurre en la página.
  "coupon_view",
  "coupon_copy",
];

// Los eventos que ocurren dentro de un cupón. Igual que con las cartas, el id
// solo viaja con estos: forzárselo al resto sería inventar el dato.
const DE_CUPON = ["coupon_view", "coupon_copy"];

export function eventoDeCupon(valor) {
  return DE_CUPON.includes(valor);
}
