 ...
 * @param {{columnas?: number, filas?: number}} rejilla tamaño en teselas (4x2:
 *        una tira ancha, que es la forma que deja la tarjeta)
 ...
 */
export function planoDeMapa(puntos, ficha = null, { columnas = 4, filas = 2 } = {}) {
  ...
  for (let z = ZOOM_MAX; z >= ZOOM_MIN && !elegido; z -= 1) {
